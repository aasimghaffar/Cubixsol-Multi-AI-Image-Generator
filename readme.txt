...
* **OpenAI (DALL-E 3)** — industry-leading prompt understanding
...
It sends a minimal request to the live API using the key you entered. Where a service offers a free verification endpoint, you get a definitive valid/invalid answer. Where it doesn't (some services only validate keys during a paid generation), the plugin tells you exactly that instead of guessing.
...
= 1.0.0 =
* Initial release
* 9 AI engines: Pollinations.ai (free, keyless), OpenAI DALL-E 3, Google Gemini, Grok/xAI, Stability AI, FLUX (Together AI), Leonardo.Ai, Ideogram, DeepAI
